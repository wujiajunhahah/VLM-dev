...
struct InfoView: View {
    ...
    let paragraph2 = "This app showcases the **FastVLM** model in action, allowing users to freely customize the prompt. FastVLM utilizes Qwen2-Instruct LLMs without additional safety tuning, so please exercise caution when modifying the prompt. It also supports a timed capture mode to log emojis over time for daily activity visualization."
